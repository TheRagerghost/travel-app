<template>
  ...
  <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" id="login_form">
    <div class="mb-4">
    ...
    <div class="flex items-center justify-between">
      <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" @click="regUser">
        Sign In
      </button>
    </div>
  </form>
  <p class="text-center text-gray-500 text-xs">
    &copy;2022 Vishnyakov Andrey 201-327
  </p>
</div>
</template>
...
function regUser(){
  ...
  store.addUser(formData.get('username'), formData.get('password'))
